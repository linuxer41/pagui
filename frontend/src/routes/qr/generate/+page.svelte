...
<PageLayout title="Generar QR">
  ...
  <button class="link" onclick={() => goto('/qr/history')}>
...
<style>
  ...
  .link { display: flex; align-items: center; justify-content: center; gap: var(--space-2); background: none; border: none; color: var(--muted-foreground); font-size: var(--text-sm); cursor: pointer; padding: var(--space-2); }
