<script lang="ts">
  ...
  $: {
    switch (status) {
      case 404:
        errorTitle = 'Empresa no encontrada';
        errorMessage = 'La empresa que buscas no está configurada en el sistema.';
        errorDescription = 'El slug de la empresa proporcionado no existe o la empresa no ha sido configurada correctamente.';
      ...
      case 403:
        ...
        errorDescription = 'Tu cuenta no tiene los permisos necesarios para acceder a los servicios de esta empresa.';
...
<div class="error-page recaudaciones-error">
  <div class="error-container">
    ...
    <div class="error-content">
      ...
      <div class="error-actions">
        <a href="/recaudaciones" class="btn btn-primary">
